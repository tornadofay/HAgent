                            ...
                            if (fallback != null)
                            {
                                ...
                                if (fallback.ProviderMetadata != null)
                                {
                                    foreach (var item in fallback.ProviderMetadata)
                                        fallbackMetadata[item.Key] = item.Value;
                                }
                                fallbackMetadata["structured_output_native"] = false;
                                fallbackMetadata["structured_output_native_fallback"] = true;
                                fallback.ProviderMetadata = fallbackMetadata;
                            }
                            return fallback;
                        }
