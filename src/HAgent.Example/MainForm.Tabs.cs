...
namespace HAgent.Example
{
    internal sealed partial class MainForm
    {
        private void AddFeatureTabs()
        {
            ...
            AddApiTab("Context Budget", "Run budget test", "Builds an intentionally oversized conversation and applies bounded message/character limits before provider submission.", "The resulting context should be smaller, remain in original order, preserve the configured leading messages, and keep the newest messages.", "No AI request is sent by this example.", TestContextBudgetAsync, "Memory boundary", "This is tokenizer-free and uses a deterministic character-based budget; a provider-specific tokenizer can be added later.");
        }
