    ...
    internal sealed partial class MainForm
    {
        ...
        private async void OpenConfiguration()
        {
            ...
            catch (Exception ex)
            {
                ...
                ShowStorageException(ex);
                OpenStorageSettingsDirectly();
            }
        }

        private void ShowStorageException(Exception exception)
        {
            if (InvokeRequired)
            {
                BeginInvoke((Action)(() => ShowStorageException(exception)));
                return;
            }
        ...
        private void OpenStorageSettingsDirectly()
        {
            if (InvokeRequired)
            {
                BeginInvoke((Action)OpenStorageSettingsDirectly);
                return;
            }
