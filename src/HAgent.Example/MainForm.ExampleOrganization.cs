...
namespace HAgent.Example
{
    internal sealed partial class MainForm
    {
        ...
        private static string GetExampleSubGroup(string title)
        {
            ...
            if (key == "CONTEXT CONTRACTS" || key == "CONTEXT ACQUISITION" || key == "CONTEXT BUDGET" || key == "CONTEXT RANKING" || key == "CONTEXT COMPACTION" || key == "CONTEXT CACHE" || key == "CONTEXT EXECUTION INTEGRATION")
                return "Context Core";
        ...
        private static string GetExampleFeatureGroup(string title)
        {
            ...
            if (key == "CONTEXT CONTRACTS" || key == "CONTEXT ACQUISITION" || key == "CONTEXT RANKING" || key == "CONTEXT COMPACTION" || key == "CONTEXT CACHE" || key == "CONTEXT EXECUTION INTEGRATION" || key == "CONTEXT BUDGET" ||
