...
namespace HAgent.Example
{
    internal sealed partial class MainForm
    {
        private void AddFeatureTabs()
        {
            ...
            AddLiveStreamingTab();
            AddApiTab("Tool Registry", "Run tool registry test", "Registers a deterministic custom tool, supplies typed arguments, executes it, reads its definition, and unregisters it without making an AI request.", "The tool should echo HAgent-tool-42, appear in the registry, and be removed successfully after verification.", "HAgent-tool-42", TestToolRegistryAsync, "Tool boundary", "This verifies the provider-independent tool registry before the model tool-call loop is enabled.");
        }
