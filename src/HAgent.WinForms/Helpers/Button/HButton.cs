using HAgent.WinForms.Helpers.Button.HButtonCore;
using HAgent.WinForms.Helpers.Button.HButtonCore.ControlShape;
using HAgent.WinForms.Helpers.Button.HButtonCore.Rendering;
using HAgent.WinForms.Helpers.Button.HButtonCore.Visuals;
using HLibraries.ImageCore;
using System;
...
namespace HAgent.WinForms.Helpers.Button
{
    [DefaultEvent("Click")]
